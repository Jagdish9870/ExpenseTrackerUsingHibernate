...
<nav class="navbar navbar-expand-lg navbar-dark bg-success">
      <div class="container-fluid">
        <a class="navbar-brand" href="#"><i class="fa-solid fa-receipt"></i> Expense Tracker</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <c:if test="${not empty loginUser}">
            <li class="nav-item">
             <a class="nav-link active" href="../user/addExpense.jsp"><i class="fa-solid fa-plus"></i> Add Expense</a>
            </li>
           <li class="nav-item">
            <a class="nav-link active" href="../user/viewExpense.jsp" ><i class="fa-solid fa-list"></i> View Expense</a>
           </li>
          </c:if>
          </ul>
